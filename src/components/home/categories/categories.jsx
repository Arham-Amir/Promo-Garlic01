...
export default function Categories() {
  const content = [
    ['#EC6839', 'Garlic Bulb', "Garlic is often sold as a whole bulb, covered with papery white skin. A garlic bulb, also known as a head of garlic, is made up of individual lobes that are attached to the main root. A clove of garlic is one of those individual lobes.", '/garlic-bulb', '/bulb/4.jpeg'],
    ['#62A86B', 'Garlic Clove', "Fresh garlic is sold in bulbs, this is an entire head of garlic that is covered in a paper like coating. The entire bulb is made up of separate pieces, each with its own paper-like coating. Each of those individual wedges or pieces is a clove of garlic.", '/garlic-clove', '/clove/1.jpeg'],
    ...
    ['#AB8FE5', 'Garlic Paste', "Garlic paste is nothing more than garlic that has been combined with some oil or water, exactly as it is described. When your recipe calls for it, remove it from the freezer or refrigerator where you stored it.", '/garlic-paste', '/paste/1.png'],
  ]
  return (
