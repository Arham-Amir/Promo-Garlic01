...
const SideBySide = () => {
  return (
    <section className='py-8 bg-[url("/images/sbsbg.jpg")]'>
      <section className='mx-auto w-full md:w-[94%] xl:w-[85%] flex flex-col md:flex-row justify-center items-center'>
        <Left />
        <Right />
      </section>
    </section>
...
function Left(params) {
  return (
    <section className='w-11/12 md:w-[50%] h-[300px] md:h-screen'>
