  ...
  return (
    ...
    <section className="w-[85%] mx-auto flex flex-row flex-wrap md:flex-nowrap justify-center md:gap-x-10 py-6">
        <a href="https://www.promodevelopers.com/" target='_blank' className="h-full mx-auto w-1/2 md:w-1/5 px-4 order-2 md:order-1">
          <LazyImage className="h-[80px] md:h-[90px] p-3 w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-green-600 transition-all duration-75" src="/logos/promodevelopers.gif"/>
        </a>
        <a href="https://www.promobrick.com/" target='_blank' className="h-full mx-auto w-1/2 md:w-1/5 px-4 order-3 md:order-2">
          <LazyImage className="h-[80px] md:h-[90px] p-3 w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-green-600 transition-all duration-75" src="/logos/promobrick.gif"/>
        </a>
        ...
        <a href="https://www.promogarlic.com/" target='_blank' className="h-full mx-auto w-1/2 md:w-1/5 px-4 order-4 md:order-4">
          <LazyImage className="h-[80px] md:h-[90px] p-3 w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-green-600 transition-all duration-75" src="/logos/promogarlic.gif"/>
        </a>
        <a href="https://www.promoland.com.pk/" target='_blank' className="h-full mx-auto w-1/2 md:w-1/5 px-4 order-5 md:order-5">
          <LazyImage className="h-[80px] md:h-[90px] p-3 w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-green-600 transition-all duration-75" src="/logos/promofarms.gif"/>
        </a>
      </section>
